...
function showSlides1(n) {
  let i;
  let slides = document.getElementsByClassName("slider1-item");
  let dots = document.getElementsByClassName("pagination1-item");
...
function showSlides2(n) {
  let i;
  let slides = document.getElementsByClassName("slider2-item");
  let dots = document.getElementsByClassName("pagination2-item");
...
function showSlides3(n) {
  let i;
  let slides = document.getElementsByClassName("slider3-item");
  let dots = document.getElementsByClassName("pagination3-item");
...
function carousel() {
  var i;
  var x = document.getElementsByClassName("slider0-item");
