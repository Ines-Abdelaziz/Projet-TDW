...
Class AdminNutritionView extends template{
...
<div class="category-header">
  ...
  <div class="category-title">Nutrition Management</div>  
</div>
<div style="padding-left: 1050px;" class="logoutwrap" ><button onclick="location.href='/AddIngredient'" class="logout" style="width: 200px !important;"  >Add Ingredient <i class="fa-solid fa-circle-plus"></i></button> </div>
<?php    
}
public function ingredients(){
	...
	<tbody>
    <?php 
        $cntr=new AdminNutritionController();
        ...
        foreach($ings as $r){
            ?><tr>
                ...
                <td><form action="./app/controllers/apiroute.php" method="post"><input name="deleteing" value="<?php echo $r['id'] ?>" hidden ><button onclick="this.form.submit()">Delete</button></form></td>
                <td><form action="./app/controllers/apiroute.php" method="post"><input name="modifying" value="<?php echo $r['id'] ?>" hidden ><button onclick="this.form.submit()">Modify</button></form></td>
            </tr><?php }
